...
const TRANSLATIONS = {
  en: {
    ...
    'how.subtitle':    "Getting your phone fixed is simple. Pick your service, bring your device in person – we handle the rest.",
    'how.step1-title': 'Choose a Repair',
    'how.step1-desc':  "Browse our repair options and select the service that matches your device's issue. Exact price is set after we inspect your phone.",
    'how.step2-title': 'Bring Your Phone',
    'how.step2-desc':  'Fill in the booking form and bring your device to us in person. We agree on a time and place that works for both of us.',
    'how.step3-title': 'Get It Back Fixed',
    'how.step3-desc':  "After the repair, we hand your device back to you directly. Track everything via the conversation link sent to your e-mail.",
    ...
    'booking.city-label':       'City',
    'booking.city-ph':          'e.g. Bratislava',
    ...
    'booking.your-details':     'Step 2 – Your details',
    ...
    'admin.my-monthly-revenue': 'My Monthly Revenue',
    ...
    'modal.appointment-date': 'Appointment Date',
    ...
    'login.select-title':    'Who are you?',
    'login.select-sub':      'Select your account to continue.',
    'login.owner-label':     'Owner',
    'login.staff-label':     'Staff',
    'login.owner-access':    'Admin access',
    'login.staff-access':    'Staff access',
    'login.back':            'Back',
    'login.enter-password':  'Enter your password',
    'login.no-users':        'No accounts configured on server.',
    ...
    /* ── Staff tab ── */
    'admin.staff':             'Staff',
    'admin.tab.staff':         'Staff – Pick Orders',
    'admin.staff.open-orders': 'Open Orders',
    'admin.staff.open-sub':    'Click "Work on it" to take an order',
    'admin.staff.my-orders':   'My Active Orders',
    'admin.staff.my-sub':      'Orders you are currently working on',
    ...
    'modal.staff-password-new': 'Password *',
  ...
  sk: {
    ...
    'how.subtitle':    'Oprava telefónu je jednoduchá. Vyberte opravu, prineste zariadenie osobne – zvyšok zariadíme my.',
    'how.step1-title': 'Vyberte opravu',
    'how.step1-desc':  'Prezrite si naše opravy a vyberte tú, ktorá zodpovedá problému vášho zariadenia. Cenu stanovíme po prehliadke telefónu.',
    'how.step2-title': 'Prineste telefón',
    'how.step2-desc':  'Vyplňte formulár a prineste zariadenie osobne. Dohodneme sa na čase a mieste, ktoré vám vyhovuje.',
    'how.step3-title': 'Dostanete späť opraveného',
    'how.step3-desc':  'Po oprave vám zariadenie odovzdáme priamo z ruky do ruky. Celý priebeh sledujete cez konverzáciu na odkaze v e-maili.',
    ...
    'booking.city-label':       'Mesto',
    'booking.city-ph':          'napr. Bratislava',
    ...
    'booking.your-details':     'Krok 2 – Vaše údaje',
    ...
    'admin.my-monthly-revenue':  'Moje mesačné tržby',
    ...
    'modal.appointment-date': 'Dátum stretnutia',
    ...
    'login.select-title':    'Kto si?',
    'login.select-sub':      'Vyberte účet pre pokračovanie.',
    'login.owner-label':     'Majiteľ',
    'login.staff-label':     'Pracovník',
    'login.owner-access':    'Admin prístup',
    'login.staff-access':    'Prístup pracovníka',
    'login.back':            'Späť',
    'login.enter-password':  'Zadajte heslo',
    'login.no-users':        'Na serveri nie sú nakonfigurované žiadne účty.',
    'login.password-label':  'Heslo',
    'login.password-ph':     'Heslo',
    'login.submit':          'Prihlásiť sa →',
    'login.submitting':      'Prihlasovanie…',

    /* ── Staff tab ── */
    'admin.staff':             'Pracovník',
    'admin.tab.staff':         'Pracovník – Výber zákaziek',
    'admin.staff.open-orders': 'Otvorené zákazky',
    'admin.staff.open-sub':    'Kliknite na „Pracujem na tom" pre prevzatie zákazky',
    'admin.staff.my-orders':   'Moje aktívne zákazky',
    'admin.staff.my-sub':      'Zákazky, na ktorých momentálne pracujete',
    ...
    'modal.staff-password-new': 'Heslo *',
